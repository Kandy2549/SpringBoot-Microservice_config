...
public class CurrencyConversion_controller {
	 ...
	 * //where {from} and {to} represents the column //return a bean back public
	 ...
	 * 
	 * //creating a new response bean and getting the response back and taking it
	 * into Bean return new CurrencyConversionBean(response.getId(),
	...
	@GetMapping("/currency-converter-figen/from/{from}/to/{to}/quantity/{quantity}")   
